...
> `frontier-session-coach` on paper/blog days. When invoked that way, turn the day's
> assigned paper into the course outputs below.
...
> ⛳ **Ground Zero Rule.** Assume the reader has never seen this paper or its subfield (though
> they can program). Before the mechanism, establish: what problem the paper attacks, why it
> exists, and how it relates to ideas the reader likely knows. Define every term, acronym, and
> piece of notation on first use. Don't assume the surrounding literature is known.
