...
export var TOYS = [
  ['Shape reader',        'm01 · Day 1', 'wf1-d01-arrays',       're-shape 24 numbers',              'viz/shape-reshaper.html'],
  ['Slice picker',        'm01 · Day 2', 'wf1-d02-indexing',     'grab a piece and break it',        'viz/slice-picker.html'],
  ...
  ['Seed recipe',         'm01 · Day 6', 'wf1-d06-seeds',        'freeze a random stream',           'viz/seed-recipe.html'],
  ...
  ['Score explorer',      'm03 · Day 2', 'wf4-d02-qkv',          'drag a question and see who wins', 'viz/qkv-score-explorer.html'],
  ['Dot-product scorer',  'm03 · Day 3', 'wf4-d03-attention-scores','flip a score to a mismatch',    'viz/dot-product-score.html'],
  ['Softmax shares',      'm03 · Day 3', 'wf4-d03-attention-scores','drag scores and move the shares','viz/softmax-shares.html'],
  ['Head splitter',       'm03 · Day 4', 'wf4-d04-multihead',    'split one width into many heads',  'viz/multihead-split.html'],
  ['Seat collider',       'm03 · Day 5', 'wf4-d05-position',     'crash two seats into one stamp',   'viz/positional-collide.html'],
