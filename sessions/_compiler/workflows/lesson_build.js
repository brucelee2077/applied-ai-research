...
const LENSES = [
  ...
  { key: 'interest', prompt: `Run: python3 sessions/_compiler/gates/coverage_judge.py ${lesson} --source ${source}. Parse the "Interest / Curiosity Judge" section. Cultivating a beginner's INTEREST is the #1 goal at this stage, so GATE on it: if overall is BELOW_NOTEBOOK or WORSE_THAN_NOTEBOOK, emit ONE P0 finding kind="interest" ("lesson does not cultivate interest as well as the notebook"; use the top_fixes as its fix); ALSO report each BELOW/WORSE lever (aspiration_hook / relevance / invites_play / momentum / breadth_spark / delight_voice / payoff) as a P1 interest finding. Bridge unavailable -> verdict PASS, note it.` },
