...
<section class="module-section" id="s1" data-sec="what">
  ...
  <div class="sec-body">
      ...
      <tr style="border-bottom:1px solid var(--line)"><td style="padding:.4rem .6rem;color:var(--ink);font-weight:600">gradient</td><td style="padding:.4rem .6rem;color:var(--ink2)">The slope of the loss for one weight — which way and how fast the error changes if you nudge that weight.</td></tr>
      <tr style="border-bottom:1px solid var(--line)"><td style="padding:.4rem .6rem;color:var(--ink);font-weight:600">gradient descent</td><td style="padding:.4rem .6rem;color:var(--ink2)">The rule for getting better: take a small step in the downhill direction, feel the slope, step again.</td></tr>
      <tr style="border-bottom:1px solid var(--line)"><td style="padding:.4rem .6rem;color:var(--ink);font-weight:600">learning rate</td><td style="padding:.4rem .6rem;color:var(--ink2)">How big each downhill step is — too big overshoots the bottom, too small crawls.</td></tr>
      <tr style="border-bottom:1px solid var(--line)"><td style="padding:.4rem .6rem;color:var(--ink);font-weight:600">backpropagation</td><td style="padding:.4rem .6rem;color:var(--ink2)">The trick that finds the slope for every weight at once by working backward from the error.</td></tr>
      <tr style="border-bottom:1px solid var(--line)"><td style="padding:.4rem .6rem;color:var(--ink);font-weight:600">chain rule</td><td style="padding:.4rem .6rem;color:var(--ink2)">To get the slope through a chain of steps, multiply the little slope of each step together.</td></tr>
      <tr><td style="padding:.4rem .6rem;color:var(--ink);font-weight:600">vanishing gradients</td><td style="padding:.4rem .6rem;color:var(--ink2)">When many small slopes multiply through a deep network, the result shrinks to near zero, so early layers stop learning.</td></tr>
      </tbody></table>
