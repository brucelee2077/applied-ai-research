...
<section class="module-section" id="s1" data-sec="what">
  ...
  <div class="sec-body">
      ...
      <tr style="border-bottom:1px solid var(--line)"><td style="padding:.4rem .6rem;color:var(--ink);font-weight:600">learning rate</td><td style="padding:.4rem .6rem;color:var(--ink2)">The number that decides how big a step training takes each time it updates the model.</td></tr>
      <tr style="border-bottom:1px solid var(--line)"><td style="padding:.4rem .6rem;color:var(--ink);font-weight:600">hyperparameter</td><td style="padding:.4rem .6rem;color:var(--ink2)">A setting you choose yourself before training starts; the model never figures it out for you.</td></tr>
      <tr style="border-bottom:1px solid var(--line)"><td style="padding:.4rem .6rem;color:var(--ink);font-weight:600">loss curve</td><td style="padding:.4rem .6rem;color:var(--ink2)">A picture of how wrong the model is, drawn over time as training goes on.</td></tr>
      <tr style="border-bottom:1px solid var(--line)"><td style="padding:.4rem .6rem;color:var(--ink);font-weight:600">diverge</td><td style="padding:.4rem .6rem;color:var(--ink2)">When the error grows bigger and bigger instead of shrinking, until the numbers blow up.</td></tr>
      <tr style="border-bottom:1px solid var(--line)"><td style="padding:.4rem .6rem;color:var(--ink);font-weight:600">warmup</td><td style="padding:.4rem .6rem;color:var(--ink2)">Starting with tiny steps and slowly making them bigger, so a fresh, shaky model doesn't break early.</td></tr>
      <tr><td style="padding:.4rem .6rem;color:var(--ink);font-weight:600">decay</td><td style="padding:.4rem .6rem;color:var(--ink2)">Slowly shrinking the step size later on, so the model can gently settle into a good answer.</td></tr>
      </tbody></table>
