...
<section class="module-section" id="s4" data-sec="why">
  ...
  <div class="sec-body">
      ...
      <table style="width:100%;border-collapse:collapse;margin:16px 0;font-size:.84rem">
        <thead><tr style="text-align:left;border-bottom:2px solid var(--line2)"><th style="padding:.5rem .6rem;color:var(--ok-ink)">Optimizer</th><th style="padding:.5rem .6rem;color:var(--k)">Update rule</th><th style="padding:.5rem .6rem;color:var(--v)">State per weight</th><th style="padding:.5rem .6rem;color:var(--muted)">Speed vs. cost</th></tr></thead>
        <tbody>
          <tr style="border-bottom:1px solid var(--line)"><td style="padding:.5rem .6rem;color:var(--ink);font-weight:600">SGD</td><td style="padding:.5rem .6rem;color:var(--ink2)"><code>w ← w − lr·g</code></td><td style="padding:.5rem .6rem;color:var(--ink2)">none (0 extra)</td><td style="padding:.5rem .6rem;color:var(--ink2)">slowest, cheapest</td></tr>
          <tr style="border-bottom:1px solid var(--line)"><td style="padding:.5rem .6rem;color:var(--ink);font-weight:600">Momentum</td><td style="padding:.5rem .6rem;color:var(--ink2)"><code>v ← β·v + g</code>, then <code>w ← w − lr·v</code></td><td style="padding:.5rem .6rem;color:var(--ink2)">velocity <code>v</code> (1 extra)</td><td style="padding:.5rem .6rem;color:var(--ink2)">rolls through bumps; small memory</td></tr>
          <tr><td style="padding:.5rem .6rem;color:var(--ink);font-weight:600">Adam</td><td style="padding:.5rem .6rem;color:var(--ink2)"><code>w ← w − lr·m̂/(√v̂+ε)</code></td><td style="padding:.5rem .6rem;color:var(--ink2)"><code>m</code> and <code>v</code> (2 extra ≈ 2× weights)</td><td style="padding:.5rem .6rem;color:var(--ink2)">fastest to converge; highest memory</td></tr>
        </tbody>
      </table>
