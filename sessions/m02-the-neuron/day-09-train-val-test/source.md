...
<section class="module-section" id="s1" data-sec="what">
  ...
  <div class="sec-body">
      ...
      <tr style="border-bottom:1px solid var(--line)"><td style="padding:.4rem .6rem;color:var(--ink);font-weight:600">training set</td><td style="padding:.4rem .6rem;color:var(--ink2)">The practice problems the model learns from — the only data that changes its settings.</td></tr>
      <tr style="border-bottom:1px solid var(--line)"><td style="padding:.4rem .6rem;color:var(--ink);font-weight:600">validation set</td><td style="padding:.4rem .6rem;color:var(--ink2)">Fresh questions held back to check if it really learned, used to tune choices but never learned on.</td></tr>
      <tr style="border-bottom:1px solid var(--line)"><td style="padding:.4rem .6rem;color:var(--ink);font-weight:600">test set</td><td style="padding:.4rem .6rem;color:var(--ink2)">The final exam, locked away and looked at exactly once for an honest score.</td></tr>
      <tr style="border-bottom:1px solid var(--line)"><td style="padding:.4rem .6rem;color:var(--ink);font-weight:600">overfitting</td><td style="padding:.4rem .6rem;color:var(--ink2)">When a model aces the data it studied but flops on new data because it memorized instead of learning.</td></tr>
      <tr style="border-bottom:1px solid var(--line)"><td style="padding:.4rem .6rem;color:var(--ink);font-weight:600">train-val gap</td><td style="padding:.4rem .6rem;color:var(--ink2)">The space between training loss and validation loss; when it grows, the model is memorizing.</td></tr>
      <tr><td style="padding:.4rem .6rem;color:var(--ink);font-weight:600">early stopping</td><td style="padding:.4rem .6rem;color:var(--ink2)">Keep the model from the moment validation loss was lowest, and quit once it starts rising.</td></tr>
      </tbody></table>
