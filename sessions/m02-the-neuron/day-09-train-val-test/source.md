...
<section class="module-section" id="s7" data-sec="produce">
  ...
  <div class="sec-body">
      <p>Here's the experiment worth running. <b>Before you run it, predict:</b> you'll fit polynomials of degree 1, 3, 5, and 9 to the same noisy points — which degree wins on the held-out data? Jot your guess. Then run it and watch the validation loss bottom out at a <em>middle</em> degree while the training loss just keeps falling with every extra degree. That U-turn in the validation curve is the exam-vs-answer-key moment made visible. Pick one path:</p>
...
var DEMOS = {
  ...
  gap:{html:'<span class="prompt">&gt;&gt;&gt;</span> <span class="kw">for</span> step <span class="kw">in</span> [<span class="num">100</span>, <span class="num">200</span>, <span class="num">300</span>, <span class="num">400</span>, <span class="num">500</span>]:\n'+
    ...
    take:'<b>②  The gap opens.</b> Training loss keeps falling, but around step 300 the validation loss turns around and climbs. That turning point is where the model starts memorizing instead of learning.'},
